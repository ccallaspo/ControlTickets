...
<head>
    ...
    <title>Notificación - Cotización Aprobada</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Sigue el flujo de trabajo para completar el proceso.</p>
        </div>

        <div class="content">
            <h2>Estimado colaborador,</h2>

            <p>Una cotización ha sido aprobada. El siguiente paso es agendar el curso.</p>

            @if(isset($data))
            <h3>Detalles:</h3>
            <ul>
                <li><strong>Ticket:</strong> {{ $data->name ?? 'N/A' }}</li>
                <li><strong>Cotización:</strong> {{ $data->referent ?? 'N/A' }}</li>
                <li><strong>Curso:</strong> {{ $data->name_course ?? 'N/A' }}</li>
                <li><strong>Código:</strong> {{ $data->formatted_id_sence ?: 'N/A' }}</li>
                <li><strong>Actualizado por:</strong> {{ $myuser->name ?? 'N/A' }}</li>
