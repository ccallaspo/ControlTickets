...
Route::get('/download-pdf-v2/{id}', [PdfController::class, 'downloadV2'])->name('pdf.download.v2');
...
Route::get('/cotizacion/{cotizacion}/clonar', [CotizacionController::class, 'clonar'])
    ->name('cotizacion.clonar')
    ->middleware(['auth']);
